...
{
	printf("do_divide_error(0),ERROR_CODE:%x, RSP:%x, RIP:%x\n",error_code , regs->rsp , regs->rip);
	while(1);
}
...
{
	printf("do_debug(1),ERROR_CODE:%x,RSP:%x,RIP:%x\n", error_code , regs->rsp , regs->rip);
	while(1);
}
...
{
	printf("do_nmi(2),ERROR_CODE:%x,RSP:%x,RIP:%#x\n",error_code , regs->rsp , regs->rip);
	while(1);
}
...
{
	printf("do_int3(3),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
	while(1);
}
...
{
	printf("do_overflow(4),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
	while(1);
}
...
{
	printf("do_bounds(5),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
	while(1);
}
...
{
	printf("do_undefined_opcode(6),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
	while(1);
}
...
{
	printf("do_dev_not_available(7),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
	while(1);
}
...
{
	printf("do_double_fault(8),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
	while(1);
}
...
{
	printf("do_coprocessor_segment_overrun(9),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
	while(1);
}
...
{
	printf("do_invalid_TSS(10),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
	...
	printf("Segment Selector Index:%x\n",error_code & 0xfff8);
...
{
	printf("do_segment_not_present(11),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
...
{
	printf("do_stack_segment_fault(12),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
...
{
	printf("do_general_protection(13),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
...
void do_page_fault(struct pt_regs * regs,unsigned long error_code)
{
	...
	printf("do_page_fault(14),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
...
{
	printf("do_x87_FPU_error(16),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
	while(1);
}
...
{
	printf("do_alignment_check(17),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
	while(1);
}
...
{
	printf("do_machine_check(18),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
	while(1);
}
...
{
	printf("do_SIMD_exception(19),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
	while(1);
}
...
{
	printf("do_virtualization_exception(20),ERROR_CODE:%x,RSP:%x,RIP:%x\n",error_code , regs->rsp , regs->rip);
	while(1);
}
